...
export default function EditJournalEntryPage() {
    ...
    const fetchItem = async () => {
        try {
            const response = await api.get(`/accounting/journal-entrys/${id}/`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await api.put(`/accounting/journal-entrys/${id}/`, formData);
    ...
    const handleDelete = async () => {
        if (confirm('آیا از حذف این مورد اطمینان دارید؟')) {
            try {
                await api.delete(`/accounting/journal-entrys/${id}/`);
                router.push('/dashboard/accounting/journal-entrys');
            } catch (error) {
